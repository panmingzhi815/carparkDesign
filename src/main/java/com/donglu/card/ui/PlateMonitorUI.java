...
public class PlateMonitorUI {
	...
	protected void createContents() {
		...
		CTabFolder tabFolder = new CTabFolder(composite_2, SWT.BORDER | SWT.FLAT);
		tabFolder.setTabHeight(27);

		Composite composite2 = new Composite(tabFolder, SWT.FLAT);
		...
		Button lb = new Button(composite2, SWT.FLAT);
		lb.setToolTipText("抓拍");
		lb.setImage(SWTResourceManager.getImage(PlateMonitorUI.class, "/image/snapshot_16.png"));
		lb.setCursor(new Cursor(null, SWT.CURSOR_HAND));

		Button lb2 = new Button(composite2, SWT.FLAT);
		lb2.setToolTipText("开闸");
		lb2.setImage(SWTResourceManager.getImage(PlateMonitorUI.class, "/image/up_16.png"));
		lb2.setCursor(new Cursor(null, SWT.CURSOR_HAND));

		tabFolder.setTopRight(composite2, SWT.RIGHT);

		CTabItem tbtmNewItem = new CTabItem(tabFolder, SWT.NONE);
		tbtmNewItem.setFont(SWTResourceManager.getFont("微软雅黑", 10, SWT.BOLD));
		...
		tbtmNewItem_1.setFont(SWTResourceManager.getFont("微软雅黑", 10, SWT.BOLD));
		...
		CTabFolder tabFolder_1 = new CTabFolder(composite_3, SWT.BORDER | SWT.FLAT);
		tabFolder_1.setTabHeight(27);

		Composite composite3 = new Composite(tabFolder_1, SWT.FLAT);
		...
		Button lb3 = new Button(composite3, SWT.FLAT);
		lb3.setToolTipText("抓拍");
		lb3.setImage(SWTResourceManager.getImage(PlateMonitorUI.class, "/image/snapshot_16.png"));
		lb3.setCursor(new Cursor(null, SWT.CURSOR_HAND));

		Button lb4 = new Button(composite3, SWT.FLAT);
		lb4.setToolTipText("开闸");
		lb4.setImage(SWTResourceManager.getImage(PlateMonitorUI.class, "/image/up_16.png"));
		lb4.setCursor(new Cursor(null, SWT.CURSOR_HAND));

		tabFolder_1.setTopRight(composite3, SWT.RIGHT);

		CTabItem tbtmNewItem_2 = new CTabItem(tabFolder_1, SWT.NONE);
		tbtmNewItem_2.setFont(SWTResourceManager.getFont("微软雅黑", 10, SWT.BOLD));
		tbtmNewItem_2.setText("北岗亭出口视频");
		tabFolder_1.setSelection(tbtmNewItem_2);
		...
		tbtmNewItem_3.setFont(SWTResourceManager.getFont("微软雅黑", 10, SWT.BOLD));
...

		{
			...
			}
			{
				...
				GridData gd_btnf_1 = new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1);
				gd_btnf_1.widthHint = 130;
				btnf_1.setLayoutData(gd_btnf_1);
				btnf_1.setText("换班(F7)");
				btnf_1.setFont(SWTResourceManager.getFont("微软雅黑", 12, SWT.BOLD));
			}
			{
				Button btnf_2 = new Button(composite_9, SWT.NONE);
				GridData gd_btnf_2 = new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1);
				gd_btnf_2.widthHint = 130;
				btnf_2.setLayoutData(gd_btnf_2);
				btnf_2.setText("归账(F8)");
				btnf_2.setFont(SWTResourceManager.getFont("微软雅黑", 12, SWT.BOLD));
			}
			{
				Button btnf = new Button(composite_9, SWT.NONE);
				GridData gd_btnf = new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1);
				gd_btnf.widthHint = 130;
				...
				btnf.setFont(SWTResourceManager.getFont("微软雅黑", 12, SWT.BOLD));
			}
		}
	}
